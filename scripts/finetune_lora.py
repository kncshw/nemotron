#!/usr/bin/env python3
"""
LoRA fine-tuning for Nemotron models using HuggingFace PEFT.

Mock run (L4):  python3 finetune_lora.py --mock
GB10 run:       python3 finetune_lora.py
...
PROD_MODEL = "nvidia/NVIDIA-Nemotron-3-Super-120B-A12B-NVFP4"
