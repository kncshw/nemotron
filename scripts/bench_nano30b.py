#!/usr/bin/env python3
"""
Throughput benchmark for Nemotron-3-Nano-30B-A3B-FP8 on GB10.
...
Usage:
    python3 bench_nano30b.py                          # quick benchmark
    python3 bench_nano30b.py --full                   # full benchmark suite
    python3 bench_nano30b.py --concurrent 1 3 5 10    # custom concurrency levels
    python3 bench_nano30b.py --base-url http://host:8001/v1
    python3 bench_nano30b.py --output results.json    # save results to file
"""
...
def main():
    parser = argparse.ArgumentParser(description="Benchmark Nemotron-3-Nano-30B-A3B-FP8")
    ...
    # Concurrent test
    levels = args.concurrent or ([1, 3, 5, 10] if args.full else [1, 3, 5])
